...
<head>
    ...
    <script type="text/javascript" charset="UTF-8"
        src="https://translate.googleapis.com/translate_static/js/element/main_ru.js"></script>
    <script type="text/javascript" src="js/flexslider.load.js?pxmdc7"></script>
    <script type="text/javascript" charset="UTF-8"
        src="https://translate.googleapis.com/element/TE_20190916_00/e/js/element/element_main.js"></script>
...
<body style="visibility: visible;">
    <!--  class="page page_fix" background="%images%/bg.png"-->
    <a href="#" class="bvi-open" title="Версия сайта для слабовидящих">
        <font align="right">Версия сайта для слабовидящих</font>
    </a><br />
